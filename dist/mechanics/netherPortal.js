...
exports.construirNetherPortal = construirNetherPortal;
function construirNetherPortal(bot) {
    const obsidian = bot.inventory.items().filter((i) => i.name.includes('obsidian'));
    const flintSteel = bot.inventory.items().find((i) => i.name.includes('flint_and_steel'));
